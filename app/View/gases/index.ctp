...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/gasesdeproteccion', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Gase']['id']; ?>">
		  ...
		  if($dat['Gase']['smallimage'] != "") {
		  	echo $this->Html->image('/'.$dat['Gase']['smallimage'], array('class' => 'imagen'));
		  } else {
