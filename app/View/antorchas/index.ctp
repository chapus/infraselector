...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/lasantorchas', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Antorcha']['id']; ?>">
		  ...
		  if($dat['Antorcha']['image'] != "") {
		  	echo $this->Html->image('/'.$dat['Antorcha']['smallimage'], array('class' => 'imagen'));
		  } else {
