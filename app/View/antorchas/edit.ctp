...
<h3><?= $this->Html->image('infrasmall.png'); ?> Editar antorcha</h3>
...
echo $this->Form->input('id');
		...
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Nombre completo de la antorhca', array('class' => 'inputmsg') );
