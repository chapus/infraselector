...
<h3><?= $this->Html->image('infrasmall.png'); ?> máquinas - ciclos de trabajo</h3>
<p>&nbsp;</p>
<div class="search">
...
//debug($data);
//debug($this->data);
	echo $this->Form->create('Ciclomaquina', array(
...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Agregar Nuevo</span></button>", array('controller' => 'ciclomaquinas', 'action' => 'add'), array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Ciclomaquina']['id']; ?>">
          <td><?= $dat['Ciclomaquina']['name']; ?></td>
          <td><?= $dat['Ciclomaquina']['description']; ?></td>
          
          <td><?= date("F j, Y", strtotime($dat['Ciclomaquina']['created'])); ?></td>
          
          <td><?php 
		  echo $this->Html->link('Ver', array('controller' => 'ciclomaquinas', 'action' => 'viewby', $dat['Ciclomaquina']['id']))."<br />"; 
		  echo $this->Html->link('Editar', array('controller' => 'ciclomaquinas', 'action' => 'edit', $dat['Ciclomaquina']['id'].'/'.str_replace(array('/', ':'), array('_', '-'), $this->params['url']['url']) ))."<br />"; 
		  ?></td>
        </tr>
<?php
}
