...
echo $this->Form->input('id');
		...
		echo $this->Form->input('seccion_id', array('label' => 'Sección', 'empty' => true)).$this->Html->tag('div', 'Sección a la que pertenece', array('class' => 'inputmsg') );
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en Artículo de Protección como link para mayor información.', array('class' => 'inputmsg') );
