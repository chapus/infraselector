...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/articulosdeproteccion', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Proteccione']['id']; ?>">
		  ...
		  if($dat['Proteccione']['image'] != "") {
		  	echo $this->Html->image('/'.$dat['Proteccione']['smallimage'], array('class' => 'imagen'));
		  } else {
