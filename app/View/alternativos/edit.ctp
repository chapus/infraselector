...
<?php echo $this->Form->create('Alternativo', array('type' => 'file'));
echo $this->Form->input('id');

		echo $this->Form->input('codigo', array('label' => 'Código')).$this->Html->tag('div', 'Código del Producto', array('class' => 'inputmsg') );
		
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Nombre completo del Equipo Alternativo', array('class' => 'inputmsg') );
		
		echo $this->Form->input('short', array('label' => 'Nombre Corto')).$this->Html->tag('div', 'Nombre popular o corto del Equipo Alternativo. Nota: este nombre sale debajo del nombre completo en letras pequeñas.', array('class' => 'inputmsg') );
		...
		echo $this->Form->input('shortdescription', array('label' => 'Pequeña Descripción')).$this->Html->tag('div', 'Descripción que saldrá abajo de la imagen, en el selector.', array('class' => 'inputmsg') );
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en el Equipo Alternativo como link para mayor información.', array('class' => 'inputmsg') );
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Guardar Equipo Alternativo</span>
    </button> 
</div>    
</form> 
</div>
