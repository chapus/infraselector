...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/materialesdeaporte', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Ccalidade']['id']; ?>">
		  ...
		  if($dat['Ccalidade']['image'] != "") {
		  	echo $this->Html->image('/'.$dat['Ccalidade']['smallimage'], array('class' => 'imagen'));
		  } else {
...
'format' => __('Página %page% de %pages%, mostrando %current% aportes de lámina de %count% en total, empezando del calibre de lámina %start%, al %end%', true)
));
?>	</p>
	<div class="paging">
