...
<h3><?= $this->Html->image('infrasmall.png'); ?> Nuevo Calibre de Lámina (Espesor)</h3>

<?php 
echo $this->Form->create('Calibre', array('type' => 'file'));
?>
<div class="submit">
    <button class="rounded" id="submit">
      <span>Guardar Calibre de Lámina</span>
    </button> 
</div>   
<?php
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Nombre completo del Calibre de lámina','inputmsg');
		
		echo $this->Form->input('short', array('label' => 'Nombre Corto')).$this->Html->tag('div', 'Nombre popular o corto del Calibre de lámina. Nota: este nombre sale debajo del nombre completo en letras pequeñas.','inputmsg');
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en el Calibre de lámina como link para mayor información.','inputmsg');
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Agregar Nuevo Calibre de Lámina</span>
    </button> 
</div>    
</form> 
</div>
