...
<?php echo $this->Form->create('Calidadgase', array('type' => 'file'));
		...
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Título que aparecerá en el selector, abajo de la imagen del Gas. Es una nota importante para el usuario.', array('class' => 'inputmsg') );
		...
		echo '<div class="mig_color">';
			echo $this->Form->input('MigCalibre', array('size' => 50) );
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Guardar Condición de Calidad</span>
    </button> 
</div>    
</form> 
</div>
