...
<h4><?php echo $aporte['Aporte']['name']; ?></h4>
<h5><?php echo $aporte['Aporte']['short']; ?></h5>
<div class="line"></div>
<div class="image"><?php if($aporte['Aporte']['image'] != "") { echo $this->Html->image('/'.$aporte['Aporte']['smallimage']); } ?></div>

<div class="info"><?php echo $aporte['Aporte']['description']; ?></div>

<div class="infralink"><?php if($aporte['Aporte']['infra_link'] != "") { echo $this->Html->link('Más información, click aquí', $aporte['Aporte']['infra_link'], array('target' => '_blank')); } ?></div>
