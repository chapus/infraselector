...
<h3><?= $this->Html->image('infrasmall.png'); ?> Nuevo Material de Aporte</h3>
...
<?php echo $this->Form->create('Aporte', array('type' => 'file'));
		...
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Nombre completo del Material de Aporte', array('class' => 'inputmsg') );
		
		echo $this->Form->input('short', array('label' => 'Nombre Corto')).$this->Html->tag('div', 'Nombre popular o corto del Material de Aporte. Nota: este nombre sale debajo del nombre completo en letras pequeñas.', array('class' => 'inputmsg') );
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en el Material de Aporte como link para mayor información.', array('class' => 'inputmsg') );
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Agregar Nuevo Material de Aporte</span>
    </button> 
</div>    
</form> 
</div>
