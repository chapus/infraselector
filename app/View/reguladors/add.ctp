...
<h3><?= $this->Html->image('infrasmall.png'); ?> Nuevo Regulador de Presión</h3>

<?php echo $this->Form->create('Regulador');
		...
		echo $this->Form->input('Proteccione');
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Agregar Nuevo Regulador de Presión</span>
    </button> 
</div>    
</form> 
</div>
