...
<h3><?= $this->Html->image('infrasmall.png'); ?> Nuevo Alimentador de Micro Alambre</h3>
...
<?php echo $this->Form->create('Microalambre', array('type' => 'file'));
		...
		echo $this->Form->input('name', array('label' => 'Nombre Completo')).$this->Html->tag('div', 'Nombre completo del Alimentador de Micro Alambre','inputmsg');
		
		echo $this->Form->input('short', array('label' => 'Nombre Corto')).$this->Html->tag('div', 'Nombre popular o corto del Alimentador de Micro Alambre. Nota: este nombre sale debajo del nombre completo en letras pequeñas.','inputmsg');
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en el Alimentador de Micro Alambre como link para mayor información.','inputmsg');
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Agregar Nuevo Alimentador de Micro Alambre</span>
    </button> 
</div>    
</form> 
</div>
