...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Agregar Nuevo</span></button>", array('controller' => 'microalambres', 'action' => 'add'), array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Microalambre']['id']; ?>">
          ...
          <td><?= date("F j, Y", strtotime($dat['Microalambre']['created'])); ?></td>
          
          <td><?php 
		  echo $this->Html->link('Ver', array('controller' => '', 'action' => 'alimentadores', $dat['Microalambre']['id']))."<br />"; 
		  echo $this->Html->link('Editar', array('controller' => 'microalambres', 'action' => 'edit', $dat['Microalambre']['id']))."<br />"; 
		  ?></td>
        </tr>
<?php
}
