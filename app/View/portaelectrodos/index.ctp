...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/portaelectrodos', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Portaelectrodo']['id']; ?>">
		  ...
		  if($dat['Portaelectrodo']['smallimage'] != "") {
		  	echo $this->Html->image('/'.$dat['Portaelectrodo']['smallimage'], array('class' => 'imagen'));
		  } else {
