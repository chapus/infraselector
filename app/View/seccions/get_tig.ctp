...
foreach ($protecciones as $proteccion) {
	...
	<span><a href='#' id='ver".$proteccion['Proteccione']['id']."'>+ Ver descripción</a></span><span><input type='checkbox' name='prot".$proteccion['Proteccione']['id']."' id='prot".$proteccion['Proteccione']['id']."' class='pro' /> Agregar a la selección</span></div>";
...
if( empty($protecciones) ) {
	echo "Por el momento no tenemos protecciones de este tipo para el Proceso TIG.";
}
