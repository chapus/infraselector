...
echo $this->Form->input('id');
		...
		echo $this->Form->input('order', array('label' => 'Orden de Aparición')).$this->Html->tag('div', 'Por orden de aparición en el selector.','inputmsg');
		...
		echo $this->Form->input('infra_link', array('label' => 'Link Interno')).$this->Html->tag('div', 'El Link interno es opcional, si se tiene información adicional del producto dentro del portal de INFRA se puede poner el link aquí. Este aparecería en material a soldar como links de mayor información.','inputmsg');
