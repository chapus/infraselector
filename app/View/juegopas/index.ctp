...
<div class="admin" align="center">
	<?= $this->Html->link("<button class='rounded' id='add'><span>Quitar Filtros</span></button>", '/catalogo/maquinasdesoldar', array('escape' => false), null); ?>
    <br />
...
?>
        <tr class="<?= $trow; ?>" id="<?= "i".$dat['Juegopa']['id']; ?>">
		  ...
		  if($dat['Juegopa']['smallimage'] != "") {
		  	echo $this->Html->image('/'.$dat['Juegopa']['smallimage'], array('class' => 'imagen'));
		  } else {
