...
<h3><?= $this->Html->image('infrasmall.png'); ?> Nuevo Juego de Pas</h3>
...
<?php echo $this->Form->create('Juegopa', array('type' => 'file'));
		...
		echo $this->Form->input('file2', array('type' => 'file', 'label' => 'Imagen 2')).$this->Html->tag('div', 'La imagen no debe pesar más de 2 Megas, y el tamaño ideal tiene que ser proporcional. El máximo es de 200x200 pixeles.', array('class' => 'inputmsg') );
		
		echo $this->Form->input('file3', array('type' => 'file', 'label' => 'Imagen 3')).$this->Html->tag('div', 'La imagen no debe pesar más de 2 Megas, y el tamaño ideal tiene que ser proporcional. El máximo es de 200x200 pixeles.', array('class' => 'inputmsg') );
...
<div class="submit">
    <button class="rounded" id="submit">
      <span>Agregar Nuevo Juego de Pas</span>
    </button> 
</div>    
</form> 
</div>
