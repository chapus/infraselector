...
function DHTMLgoodies_formTooltip()
{
	...
	this.imagePath = '../img/tooltip/';
	this.arrowImageFile = 'green-arrow.gif';
	this.arrowImageFileRight = 'green-arrow-right.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#FCFAAB';
	this.closeMessage = 'Cerrar';
	this.disableTooltipMessage = 'No mostrar este mensaje de nuevo';
...
DHTMLgoodies_formTooltip.prototype = {
	...
	__createTooltip : function()
	{
		...
		this.tooltipContentDiv.style.overflow = 'hidden';
